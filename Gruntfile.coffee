...
\n
"""
    minified_comments: "/* Chosen #{version_tag()} | (c) 2011-<%= grunt.template.today('yyyy') %> by Harvest (customized by puresamari: https://github.com/puresamari/chosen) | MIT License, https://github.com/harvesthq/chosen/blob/master/LICENSE.md */\n"
