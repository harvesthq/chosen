...
"""
    ...
    'gh-pages':
      ...
      'bower':
        options:
          repo: 'https://github.com/pfiller/bower-chosen'
          tag: version_tag()
  ...
  grunt.registerTask 'publish_bower', ['package_bower', 'gh-pages:bower', 'cleanup_bower']
  grunt.registerTask 'publish_release', ['gh-pages:gh-pages','publish_bower']
  ...
  grunt.registerTask 'package_bower', 'Generate a bower.json manifest file from package.json', () ->
    pkg = grunt.file.readJSON("package.json")
  ...
  grunt.registerTask 'cleanup_bower', 'Delete generated bower.json file', () ->
