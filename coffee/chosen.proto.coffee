...
class Chosen extends AbstractChosen
  ...
  set_default_values: ->
    ...
    # HTML Templates
    @single_temp = new Template('<a href="javascript:void(0)" class="chzn-single chzn-default" tabindex="-1"><span>#{default}</span><div><b></b></div></a><div class="chzn-drop" style="left:' + (if @is_rtl then '' else '-') + '9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>')
    @multi_temp = new Template('<ul class="chzn-choices"><li class="search-field"><input type="text" value="#{default}" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chzn-drop" style="left:' + (if @is_rtl then '' else '-') + '9000px;"><ul class="chzn-results"></ul></div>')
  ...
  results_hide: ->
    ...
    @dropdown.setStyle({"left": (if @is_rtl then '' else '-') + "9000px"})
