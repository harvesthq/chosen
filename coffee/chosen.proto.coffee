class @Chosen extends AbstractChosen
  ...
  choice_destroy: (link) ->
    if this.result_deselect link.readAttribute("rel")
      ...
      this.results_hide() if !@always_open && (@is_multiple and this.choices_count() > 0 and @search_field.value.length < 1)
  ...
  keyup_arrow: ->
    if not @results_showing and not @is_multiple
      ...
      if prevs.length
        ...
        tthis.results_hide() if !@always_open and this.choices_count() > 0
        this.result_clear_highlight()
