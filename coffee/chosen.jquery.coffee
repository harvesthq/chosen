  ...
  set_up_html: ->
    ...
    if @is_multiple
      ...
      if @show_search
        ...
        container_div.html '<a href="javascript:void(0)" class="chzn-single"><span>' + @default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><ul class="chzn-results"></ul></div>'
