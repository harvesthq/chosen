...
class Chosen extends AbstractChosen
  ...
  choice_build: (item) ->
    ...
    @search_container.before  '<li class="search-choice' + optgroup_class + '" id="' + choice_id + '"><span>' + item.html + '</span><a href="javascript:void(0)" class="search-choice-close" rel="' + item.array_index + '"></a></li>'
