...
class Chosen extends AbstractChosen
  ...
  set_up_html: ->
    ...
    if @is_multiple
      ...
      @container.html '<a href="#" class="chzn-single chzn-default" tabindex="-1"><span>' + @default_text + '</span><div><b></b></div></a><div class="chzn-drop"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>'
