class AbstractChosen
  ...
  set_default_values: ->
    ...
    @allow_single_deselect = if @options.allow_single_deselect? and @form_field.options[0]? and @form_field.options[0].value is "" then @options.allow_single_deselect else false
