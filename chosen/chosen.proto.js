  ...
  */
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      this.single_no_search_temp = new Template('<a href="javascript:void(0)" class="chzn-single"><span>#{default}</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><ul class="chzn-results"></ul></div>');
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        base_template = new Element('div', container_props).update(this.multi_temp.evaluate({
          "default": this.default_text
        }));
      } else {
        if (this.show_search) {
          base_template = new Element('div', container_props).update(this.single_temp.evaluate({
            "default": this.default_text
          }));
        } else {
          base_template = new Element('div', container_props).update(this.single_no_search_temp.evaluate({
            "default": this.default_text
          }));
        }
      }
    ...
    Chosen.prototype.activate_field = function() {
      if (!this.is_multiple && !this.active_field && this.show_search) {
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if (this.result_highlight) {
        ...
        if (this.show_search) this.search_field.value = "";
        if (typeof Event.simulate === 'function') {
          this.form_field.simulate("change");
        }
        if (this.show_search) return this.search_field_scale();
      }
    };
