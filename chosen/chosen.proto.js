...
(function() {
  ...
  SelectParser = (function() {
    ...
    SelectParser.prototype.setDefaultOptions = function() {
      if (typeof $ === "function" ? $(typeof fn === "function" ? fn(typeof chosen_defaults !== "undefined" && chosen_defaults !== null) : void 0) : void 0) {
        console.log("Chosen defaults for jQuery");
        return this.default_options = $.fn.chosen_defaults;
      } else if (window.chosen_defaults != null) {
        console.log("Chosen defaults for prototype");
        return this.default_options = window.chosen_defaults;
      } else {
        console.log("Chosen defaults!");
        return this.default_options = {
          custom_cell_text: function(text) {
            return text;
          }
        };
      }
      ...
      if (option.nodeName.toUpperCase() === "OPTION") {
        if (option.text !== "") {
          ...
          this.parsed.push({
            ...
            value: option.value,
            text: option.text,
            html: this.default_options != null ? this.default_options.custom_cell_text(option.innerHTML) : option.innerHTML,
