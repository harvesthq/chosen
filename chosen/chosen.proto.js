...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      return this.firefox = window.navigator.userAgent.toLowerCase().indexOf("firefox" !== -1);
    };
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.register_observers = function() {
      ...
      this.search_field.observe("keypress", function(evt) {
        return _this.keypress_checker(evt);
      });
      this.search_field.observe("focus", function(evt) {
        return _this.input_focus(evt);
      });
      if (this.firefox) {
        this.search_field.observe("text", function(evt) {
    ...
    Chosen.prototype.keypress_checker = function(evt) {
      var stroke, _ref1;
