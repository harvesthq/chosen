  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.result_add_group = function(group) {
      if (!group.disabled) {
        ...
        return '<li id="' + group.dom_id + '" class="chzn-group-result">' + group.label.escapeHTML() + '</li>';
      } else {
        return "";
      }
    };
    ...
    Chosen.prototype.search_results_mouseup = function(evt) {
      ...
      target = evt.target.hasClassName("chzn-active-result") ? evt.target : evt.target.up(".chzn-active-result");
      if (target) {
    ...
    Chosen.prototype.search_results_mouseout = function(evt) {
      if (evt.target.hasClassName('chzn-active-result') || evt.target.up('.chzn-active-result')) {
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if (this.result_highlight) {
        ...
        if (this.is_multiple) {
          ...
          this.search_results.descendants(".chzn-result-selected").invoke("removeClassName", "chzn-result-selected");
    ...
    Chosen.prototype.result_activate = function(el) {
      return el.addClassName("chzn-active-result");
    };

    Chosen.prototype.result_deactivate = function(el) {
      return el.removeClassName("chzn-active-result");
    };
    ...
    Chosen.prototype.winnow_results_clear = function() {
      ...
      for (_i = 0, _len = lis.length; _i < _len; _i++) {
        ...
        } else if (!this.is_multiple || !li.hasClassName("chzn-result-selected")) {
    ...
    Chosen.prototype.winnow_results_set_highlight = function() {
      ...
      if (!this.result_highlight) {
        if (!this.is_multiple) {
          do_high = this.search_results.down(".chzn-result-selected.chzn-active-result");
        }
        if (do_high == null) {
          do_high = this.search_results.down(".chzn-active-result");
        }
        if (do_high != null) {
    ...
    Chosen.prototype.keydown_arrow = function() {
      ...
      actives = this.search_results.select("li.chzn-active-result");
      if (actives.length) {
        if (!this.result_highlight) {
