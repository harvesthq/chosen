...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      return this.show_options_when_not_found = this.options.show_options_when_not_found || false;
    };
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.winnow_results = function() {
      ...
      if (results < 1 && searchText.length) {
        if (this.show_options_when_not_found) {
          this.winnow_results_clear();
          if (!(this.form_field.options.length <= this.disable_search_threshold)) {
    ...
    Chosen.prototype.winnow_results_clear = function() {
      ...
      if (!(this.show_options_when_not_found && this.form_field.options.length > this.disable_search_threshold)) {
        this.search_field.clear();
      }
    ...
    Chosen.prototype.no_results = function(terms) {
      return this.search_results.insert({
        top: this.no_results_temp.evaluate({
          terms: terms
        })
      });
    };
