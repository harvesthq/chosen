...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      this.allow_custom_value = this.options.allow_custom_value != null ? this.options.allow_custom_value : false;
...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.setup = function() {
      ...
      if (!this.allow_custom_value) {
        return this.allow_custom_value = this.form_field_jq.hasClass("chzn-custom-value");
      }
    };
    ...
    Chosen.prototype.find_custom_group = function() {
      var found, group, _i, _len, _ref1;

      _ref1 = $('optgroup', this.form_field);
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        group = _ref1[_i];
