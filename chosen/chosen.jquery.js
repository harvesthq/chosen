...
(function() {
  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.set_default_values = function() {
      ...
      return this.results_data_callback = this.options.results_data_callback || false;
    };
...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.results_build = function() {
      ...
      if (this.results_data_callback && typeof this.results_data_callback === "function") {
        this.results_data = this.results_data_callback(this.results_data, root);
      }
    ...
    Chosen.prototype.winnow_results = function() {
      var found, option, part, parts, regex, regexAnchor, regexHtml, result, result_id, results, searchText, startpos, subHtml, subbedHtml, text, zregex, _i, _j, _len, _len1, _ref;
