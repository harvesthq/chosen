...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        container_div.html('<ul class="chzn-choices"><li class="chzn-search-field"><input type="text" value="' + this.default_text + '" class="chzn-default" autocomplete="off" style="width:25px;" /></li></ul><div class="chzn-drop" style="left:-9000px;"><ul class="chzn-results"></ul></div>');
      } else {
    ...
    Chosen.prototype.result_do_highlight = function(el) {
      ...
      if (el.length) {
        ...
        this.result_highlight.addClass("chzn-highlighted");
    ...
    Chosen.prototype.result_clear_highlight = function() {
      if (this.result_highlight) {
        this.result_highlight.removeClass("chzn-highlighted");
      }
    ...
    Chosen.prototype.show_search_field_default = function() {
      if (this.is_multiple && this.choices < 1 && !this.active_field) {
        ...
        return this.search_field.addClass("chzn-default");
      } else {
        this.search_field.val("");
        return this.search_field.removeClass("chzn-default");
      }
    };
    ...
    Chosen.prototype.search_results_mouseup = function(evt) {
      ...
      target = $(evt.target).hasClass("chzn-active-result") ? $(evt.target) : $(evt.target).parents(".chzn-active-result").first();
      if (target.length) {
    ...
    Chosen.prototype.search_results_mouseout = function(evt) {
      if ($(evt.target).hasClass("chzn-active-result" || $(evt.target).parents('.chzn-active-result').first())) {
    ...
    Chosen.prototype.result_activate = function(el) {
      return el.addClass("chzn-active-result");
    };

    Chosen.prototype.result_deactivate = function(el) {
      return el.removeClass("chzn-active-result");
    };
    ...
    Chosen.prototype.keydown_arrow = function() {
      ...
      if (!this.result_highlight) {
        first_active = this.search_results.find("li.chzn-active-result").first();
        if (first_active) {
          this.result_do_highlight($(first_active));
        }
      } else if (this.results_showing) {
        next_sib = this.result_highlight.nextAll("li.chzn-active-result").first();
        if (next_sib) {
    ...
    Chosen.prototype.keyup_arrow = function() {
      ...
      if (!this.results_showing && !this.is_multiple) {
        ...
        prev_sibs = this.result_highlight.prevAll("li.chzn-active-result");
        if (prev_sibs.length) {
